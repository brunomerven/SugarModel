...
* Set bounds
 %VAR%_CUMFLO.LO(R,P,C,ALLYEAR,LL %SOW%)$%SW1%FLO_CUM(R,P,C,ALLYEAR,LL,'LO'%SW2%) = %SW1%FLO_CUM(R,P,C,ALLYEAR,LL,'LO'%SW2%)*(1/%CUFSCAL%)*(FLO_CUM(R,P,C,ALLYEAR,LL,'N')+1);
 %VAR%_CUMFLO.UP(R,P,C,ALLYEAR,LL %SOW%)$%SW1%FLO_CUM(R,P,C,ALLYEAR,LL,'UP'%SW2%) = %SW1%FLO_CUM(R,P,C,ALLYEAR,LL,'UP'%SW2%)*(1/%CUFSCAL%)*(FLO_CUM(R,P,C,ALLYEAR,LL,'N')+1);
