...
$   BATINCLUDE bnd_set.%1 %VAR%_NCAP 'R,T,P' NCAP_BND 'R,T,P' $(RP(R,P)%SWT%)
...
* limit on commdities
*-----------------------------------------------------------------------------
$   BATINCLUDE bnd_set.%1 %VAR%_COMNET 'R,T,C,S' COM_BNDNET RTCS_VARC(R,T,C,S) %SWT%
$   BATINCLUDE bnd_set.%1 %VAR%_COMPRD 'R,T,C,S' COM_BNDPRD RTCS_VARC(R,T,C,S) %SWT%
