*=============================================================================*
* COEFMAIN.MOD oversee the bulk of the coefficient calculations
...
* derive the additional/adjusted coefficients needed for alternative objective
$IF NOT '%CTST%'=='' $BATINCLUDE coef_alt.lin %OBJ%
